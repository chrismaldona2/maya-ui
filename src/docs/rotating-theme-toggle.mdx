...
<ContainerWithTabs
  tabs={[
    {
      label: "Preview",
      content: <ComponentCard component={<RotatingThemeToggleTailwind />} />,
    },
    {
      label: "Code",
...
const MoonIcon = (props: SvgIcon) => {
  ...
  {
        label: "Usage",
        content: <CodeSnippet code={`import { ReactNode } from "react";
...
export default Layout;`} language="tsx"/>
  }]}/>
...
<ContainerWithTabs
  tabs={[
    {
      label: "Preview",
      content: <ComponentCard component={<RotatingThemeToggleMotion />} />,
    },
    {
      label: "Code",
      content:  <CodeSnippet code={`"use client";
...
{
        label: "Usage",
        content: <CodeSnippet code={`// the same as tailwind version
