...
const SidebarLink = ({ isActive, href, children }: SidebarLinkProps) => {
  return (
    <Link
      href={href}
      className={cn(
        "cursor-pointer rounded-md px-2 py-2 text-sm text-neutral-500 hover:transition-colors hover:duration-300 hover:bg-neutral-100 dark:hover:bg-neutral-900",
        {
