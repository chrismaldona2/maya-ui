    ...
    <SectionWrapper>
      <div className="flex flex-col items-start drop-shadow-sm">
        ...
        <div className="w-full px-7 py-8 bg-gradient-to-b from-[#f2f1f1] to-[#f5f5f5] dark:from-[#111111] dark:to-[#0d0d0d] rounded-b-xl rounded-tr-xl shadow-[inset_-2px_-4px_8px_rgba(200,200,200,0.1)] dark:shadow-[inset_-2px_-4px_8px_rgba(44,44,44,0.1)]">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 grid-rows-2 gap-4">
            <BentoGridItem title="Rotating theme toggle">
              <RotatingThemeToggle />
            </BentoGridItem>
            <BentoGridItem title="Greeting">
...
const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "relative bg-neutral-200 dark:bg-[#131313] rounded-xl shadow-[inset_3px_2px_2px_rgba(200,200,200,.1)] dark:shadow-[inset_2px_2px_8px_rgba(40,44,44,0.1)] overflow-hidden min-h-[250px] p-3 flex items-center justify-center col-span-1 row-span-1",
        className
      )}
    >
      {title && (
